...
std::vector<uint8_t> IV_256(64, 1);  // all bytes contain value of 1
std::vector<uint8_t> IV_512(64, 0);  // all bytes contain value of 0
...
std::array<uint8_t, 64> tau_subst{
...
std::array<uint8_t, 256> pi_subst{
...
const std::array<uint64_t, 64> mtx_A = {
